"""
Hybrid RAG Result Saver

Handles saving and loading of Hybrid RAG QA results in JSONL format.
"""
import json
import os
...
class HybridRAGSaver:
    """Save and load Hybrid RAG results"""
    ...
    def save_answer(answer_data: Dict[str, Any], model_name: str, dataset_name: str) -> None:
        ...
        """
        answer_file = PathConfig.get_hybrid_rag_path(model_name, dataset_name)
    ...
    def save_retrieval(retrieval_data: Dict[str, Any], model_name: str, dataset_name: str) -> None:
        ...
        Args:
            retrieval_data: Dictionary with keys: id, retrieved_chunks
            model_name: Name of the LLM model
            dataset_name: Name of the dataset
        """
        answer_file = PathConfig.get_hybrid_rag_path(model_name, dataset_name)
...
if __name__ == "__main__":
    ...
    # Save
    HybridRAGSaver.save_all(test_results, "deepseek-chat", "test")

    # Load
    loaded = HybridRAGSaver.load_answers("deepseek-chat", "test")
